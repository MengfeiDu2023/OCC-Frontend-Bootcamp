...
/**This is how we comment multi-line of codes. */
//This is how we comment a single line of code.
...
let firstName = "Mengfei"
let lastName = "Du"
console.log("This is my name:",firstName,lastName);

var myFavouriteGame = "Go";
console.log("This is my favourite game:",myFavouriteGame);

if (true){
    let myFavouriteDrink = "warm tea";
    var mySecondFavouriteDrink = "warm milk";
    console.log(myFavouriteDrink)
};

// console.log(myFavouriteDrink);
console.log(mySecondFavouriteDrink);
